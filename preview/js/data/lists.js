...
P.renderLists=function(){
 ...
 const days=Math.max(0,Math.round((new Date('2026-09-18T00:00:00+01:00')-new Date(new Date().toDateString()))/86400000));
 const countdown = ms<=0 ? 'YOU ARE ON YOUR WAY' : (days===1?'TOMORROW:':days===0?'TODAY:':'<b>'+days+' DAYS</b> UNTIL')+' THE 12:35 FROM GATWICK • FRI 18 SEP';
 let h='<div class="hero" style="box-shadow:8px 8px 0 #000;margin:20px 0"><div class="hbody" style="padding:18px 16px">'+
   ...
   '<h2 style="font-size:30px;margin:6px 0 4px">🎒 To-dos, packing &amp; prep</h2>'+
 ...
 h+='<div class="jpsheet"><div class="jph">e5489で予約したきっぷの受け取りをお願いします。大人2名です。クレジットカード（決済に使用したもの）、予約番号、電話番号の下4桁をお持ちしています。<br>※JR西日本のみどりの窓口、または「5489」対応の指定席券売機でお願いします。</div>';
