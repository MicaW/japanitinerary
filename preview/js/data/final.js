...
const BOOK=[
 ...
 {s:'must',t:'Sumo — pick ONE of the two, then book it',meta:'TONIGHT · 15 min · ONE SUMO, NOT TWO',
  d:'You have two candidates and the site currently half-assumes both. <b>Option A — Sumo An, Kyoto, Mon 21 Sep 18:00:</b> show-only from ¥10,000 each (with chanko meal from ¥12,800), evening shows 18:00–20:00, free cancellation up to 24 hours before. Book first, then email them the diets — their vegetarian option is arranged by email after booking, and the standard chanko is chicken-based. Note it clashes with Fushimi Inari at dusk that evening. <b>Option B — the Asakusa show, Sat 3 Oct:</b> cheaper and already near Senso-ji, but it only works if you take the Asakusa track that day <i>instead of</i> Ueno and the museum, not as well as. <b>Pick one tonight</b> — the budget already pays for one sumo show.',
