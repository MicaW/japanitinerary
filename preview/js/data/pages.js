...
const TRAINS=[
 ...
 {d:"28 SEP · MON",n:"NOZOMI 22",r:"Kyoto 13:21 → Nagoya 13:55",t:"13:21 — 65 minutes' slack for the 15:00 Shinano",p:"¥5,510 each — ¥11,020 PAID (SmartEX, Mastercard), fare included",ref:"SmartEX — in the 📄",seat:"Car 4, seats 4D · 4E",w:"Digital — register an IC card in the SmartEX app BEFORE you fly and tap that card at the gate. Smart EX also issues a QR ticket that works at the barrier (Reservation Details → Display QR-Ticket), so you have two ways through. Fares cover the Shinkansen only, not the local lines either side.",u:"https://smart-ex.jp/en/index.php",jp:"9月28日（月）　のぞみ22号　京都 13:21発 → 名古屋 13:55着　指定席　大人2名　※スマートEX予約済み",note:"Nozomi runs every 10–15 min; this one is not precious."},
 ...
 {d:"1 OCT · THU",n:"NOZOMI 122",r:"Nagoya 11:29 → Shinagawa 12:58",t:"11:29",p:"¥10,900 each — ¥21,800 PAID (SmartEX, Mastercard), fare included",ref:"SmartEX — in the 📄",seat:"Car 4, seats 10D · 10E — E is the Fuji window (Dad's)",w:"Digital — tap the IC card registered in the SmartEX app, or show the QR ticket from Reservation Details. Either works at the barrier.",u:"https://smart-ex.jp/en/index.php",jp:"10月1日（木）　のぞみ122号　名古屋 11:29発 → 品川 12:58着　指定席　大人2名　E席（富士山側）　※スマートEX予約済み",note:"Flat check-in is 15:00 — no need for an earlier one."}
];
P.TRAINS=TRAINS;
