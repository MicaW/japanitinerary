...
const HU={
 ...
 "29-sep":[
  ...
  {k:'avoid',t:'There is no afternoon pickup — the Tsumago→Nagiso buses do that job (13:00, 13:50, 15:40, 16:10 on the April 2026 timetable). Photograph the printed timetable at the Tsumago stop and trust that one.'},
 ...
 "3-oct":[
  ...
  {k:'tip',t:'Tokyo National Museum: the 70+ free entry needs ID. Hantei serves lunch 11:30–15:00, last orders 14:00, and it is a set course — book about 12:30 and say the no-meat request when you book, not on arrival.'},
 ...
 "5-oct":[
  ...
  {k:'tip',t:'BA6 departs 13:05. Bag drop at T3 opens ~10:05 and CLOSES 12:05 — miss that and you do not fly. Keikyu from Shinagawa takes about 15 minutes to T3.'}
 ]
};
window.HEADSUP=HU;
})();
