...
const VERSION = 'lampteys-v93';
const SHELL = [
  './','index.html','manifest.webmanifest',
  'js/app.js','js/data/days.js','js/data/days2.js','js/data/days3.js','js/data/pages.js','js/data/lists.js','js/data/headsup.js','js/data/gphotos.js','js/data/confirm.js',
