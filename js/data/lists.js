...
P.renderLists=function(){
 ...
 h+='<div class="btnrow" style="margin-bottom:18px"><a class="btn yellow big" style="flex:1" href="downloads/dad-departure-list.pdf" download>⬇ DAD — PDF (PRINT)</a><a class="btn mini" href="downloads/dad-departure-list.docx" download>⬇ WORD</a></div>';
 ...
 h+='<div class="info-box" data-label="The split">All the admin — bookings, tickets, insurance, Visit Japan Web, money plan, luggage plan, the Gatwick journey — is on Mica\'s list. Dad\'s list is his own prep: passport, medication, cash, phone set-up, packing. If something is not on his list, it is already being handled.</div>';
