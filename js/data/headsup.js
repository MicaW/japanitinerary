...
const HU={
 "18-sep":[
  {k:'look',t:'Air China: one cabin bag at 5 kg — weigh it at home. Power banks in the cabin only, never in the hold.'},
 ...
 "19-sep":[
  ...
  {k:'look',t:'Kyoto Station is busy all evening this week. Eat on the 10F ramen street or in Porta underground rather than the 11F restaurants, which take a queue ticket.'},
 ...
 "20-sep":[
  ...
  {k:'look',t:'Sunday of a holiday weekend: Kodai-ji and Kiyomizu will have queues at the ticket windows after 10:00; buy Kiyomizu tickets at the machines, not the manned window.'},
 ...
 "21-sep":[
  ...
  {k:'look',t:'Bike hire: Kyoto Eco Trip is 09:00–18:00. Park only in marked bicycle parking — Kyoto tows, and the fine plus the walk to the pound ruins an afternoon.'},
 ...
 "22-sep":[
  ...
  {k:'look',t:'Holiday Tuesday: Osaka Castle keep opens 09:00 and the queue is on the stairs inside, not outside. Go straight up and work down.'},
 ...
 "23-sep":[
  ...
  {k:'look',t:'Afternoon tea at the HOSHINOYA lounge is online-only and must be booked in advance; the lounge itself is walk-in. Your 14:30 boat slot is the fixed point of the day.'},
 ...
 "24-sep":[
  ...
  {k:'look',t:'Ask the desk tonight for tomorrow’s 09:00 transfer down the gorge — it is not automatic.'},
 ...
 "25-sep":[
  ...
  {k:'look',t:'The 13:57 bus is the one to make — backups 14:37, 15:11 and 16:18, and the last useful one is 16:18. Buy provisions at Amanohashidate; the village has almost no shops.'},
 ...
 "26-sep":[
  ...
  {k:'look',t:'Cash for everything today: the sea taxi, Funaya Shokudo, the café. Nowhere in the village takes cards reliably.'},
 ...
 "28-sep":[
  ...
  {k:'look',t:'Nozomi trains are reserved-seat only until 23 Sep; from today unreserved cars are back, but your seats are booked anyway. Nagiso has no IC-card gates — paper tickets in hand.'},
 ...
 "29-sep":[
  ...
  {k:'look',t:'Luggage shuttle Magome→Tsumago: ¥500 a bag, drop 08:30–11:30 at the Magome information centre, collect after 13:00 at Tsumago. Useful if the small bags feel heavy.'},
 ...
 "30-sep":[
  ...
  {k:'look',t:'Narai soba houses sell out early on busy days — lunch at 11:30, not 13:30.'},
 ...
 "1-oct":[
  ...
  {k:'look',t:'Flat check-in from 15:00. Ask the host for the exact door code and whether they accept forwarded luggage before you send anything.'},
 ...
 "3-oct":[
  ...
  {k:'look',t:'Tokyo National Museum: the 70+ free entry needs ID. Hantei takes lunch from 12:30 and is a set course; say the no-meat request when you book, not on arrival.'},
 ...
 "4-oct":[
  ...
  {k:'look',t:'DAWN café diner seating is for two or more and booked; be five minutes early, they release tables.'},
 ...
 "5-oct":[
  ...
  {k:'look',t:'BA6 departs 13:05. Bag drop at T3 opens three hours before. Keikyu from Shinagawa takes about 15 minutes to T3.'}
 ]
};
window.HEADSUP=HU;
})();
