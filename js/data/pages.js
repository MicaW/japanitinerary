...
const TRAINS=[
 {d:"19 SEP · SAT",n:"HARUKA 30",r:"Kansai Airport 14:14 → Kyoto 15:34",t:"14:14 booked — any later HARUKA's non-reserved cars if immigration is slow, or the 13:44 if it is quick",p:"¥2,200 each — ¥4,400 PAID (Amex)",ref:"41082 + your 4-digit PIN",seat:"Car 2, seats 9A · 9B",w:"COLLECT at the JR ticket machine in the KIX station after customs: the Amex, reservation 41082, your PIN, passports (visitor-only ticket).",u:"https://www.westjr.co.jp/global/en/ticket/haruka-oneway/",jp:"はるか30号　関西空港 14:14発 → 京都　大人2名　予約番号 41082",note:"Booked with seats; the ticket is valid all day on any HARUKA, so nothing is lost if the flight is late."},
 {d:"25 SEP · FRI",n:"HASHIDATE 5 (はしだて5号)",r:"Kameoka 10:43 → Amanohashidate 12:36",t:"10:43 from Kameoka (local from Saga-Arashiyama 10:14, same platform)",p:"¥4,650 each — ¥9,300 PAID (Amex), fare included",ref:"48623",seat:"Car 1, seats 8C · 8D",w:"Paper tickets — COLLECT AT KYOTO STATION ON 19 SEP: JR West machine or the ticket office by the central gates, OUTSIDE the gates. Amex + 48623 + the phone digits in the confirmation 📄. Not collectable at Amanohashidate.",u:"https://e5489.jr-odekake.net/e5489/cspc/CBTopMenuPC",jp:"9月25日（金）　特急はしだて5号　亀岡 10:43発 → 天橋立 12:36着　指定席　大人2名　e5489予約番号 48623",note:"Two trains in one — sit in the printed seats (car 1) and you are in the right half."},
 {d:"27 SEP · SUN",n:"HASHIDATE 2 (はしだて2号)",r:"Amanohashidate 09:50 → Kyoto 12:07 (platform 31)",t:"09:50",p:"¥5,000 each — ¥10,000 PAID (Amex), fare included",ref:"42734",seat:"Car 1, seats 8C · 8D",w:"Paper tickets — collected at Kyoto on 19 Sep with the others (Amex + 42734 + the phone digits from the confirmation 📄). Amanohashidate station cannot issue them.",u:"https://e5489.jr-odekake.net/e5489/cspc/CBTopMenuPC",jp:"9月27日（日）　特急はしだて2号　天橋立 9:50発 → 京都 12:07着　指定席　大人2名　e5489予約番号 42734",note:"The 08:11 bus from Ine is the only one that makes it."},
 {d:"27 SEP · SUN",n:"AONIYOSHI (あをによし)",r:"Kyoto 12:55 → Kintetsu-Nara 13:28",t:"12:55",p:"¥730 each express charge — ¥1,460 PAID (Kintetsu). The ¥760 fare is tapped with ICOCA at the gate",ref:"Kintetsu A03269",seat:"Twin seats (a pair)",w:"Ticketless — the express ticket is in the Kintetsu email. Tap ICOCA for the basic fare.",u:"https://www.ticket.kintetsu.co.jp/vs/en/e-ticket/",jp:"9月27日（日）　観光特急あをによし　京都 12:55発 → 近鉄奈良 13:28着　ツインシート　大人2名（予約済み A03269）",note:"Runs every day except Thursday."},
 {d:"28 SEP · MON",n:"NOZOMI 22",r:"Kyoto 13:21 → Nagoya 13:55",t:"13:21 — 65 minutes' slack for the 15:00 Shinano",p:"¥5,510 each — ¥11,020 PAID (SmartEX, Mastercard), fare included",ref:"SmartEX 2001",seat:"Car 4, seats 4D · 4E",w:"Digital — QR code in the SmartEX email, or link your ICOCA in the SmartEX app and tap through.",u:"https://smart-ex.jp/en/index.php",jp:"9月28日（月）　のぞみ22号　京都 13:21発 → 名古屋 13:55着　指定席　大人2名　※スマートEX予約済み 2001",note:"Nozomi runs every 10–15 min; this one is not precious."},
 {d:"28 SEP · MON",n:"SHINANO 17 (しなの17号)",r:"Nagoya 15:00 → Nagiso 16:00",t:"15:00 — platform 10 at Nagoya",p:"¥3,220 each — ¥6,440 PAID (Amex), fare included",ref:"42626",seat:"Car 2, seats 9A · 9B",w:"Paper tickets — collected at Kyoto on 19 Sep (Amex + 42626 + the phone digits from the confirmation 📄). No IC cards at Nagiso, so the paper matters.",u:"https://e5489.jr-odekake.net/e5489/cspc/CBTopMenuPC",jp:"9月28日（月）　特急しなの17号　名古屋 15:00発 → 南木曽 16:00着　指定席　大人2名　e5489予約番号 42626",note:"The ONLY afternoon Shinano that stops at Nagiso."},
 {d:"1 OCT · THU",n:"SHINANO 2 (しなの2号)",r:"Nagiso 08:09 → Nagoya 09:18",t:"08:09",p:"¥3,220 each — ¥6,440 PAID (Amex), fare included",ref:"42281",seat:"Car 3, seats 8C · 8D",w:"Paper tickets — collected at Kyoto on 19 Sep (Amex + 42281 + the phone digits from the confirmation 📄). Nagiso cannot issue them.",u:"https://e5489.jr-odekake.net/e5489/cspc/CBTopMenuPC",jp:"10月1日（木）　特急しなの2号　南木曽 8:09発 → 名古屋 9:18着　指定席　大人2名　e5489予約番号 42281",note:"The only morning Shinano that stops at Nagiso southbound. Next is 15:55."},
 {d:"1 OCT · THU",n:"NOZOMI 122",r:"Nagoya 11:29 → Shinagawa 12:58",t:"11:29",p:"¥10,900 each — ¥21,800 PAID (SmartEX, Mastercard), fare included",ref:"SmartEX 2002",seat:"Car 4, seats 10D · 10E — E is the Fuji window (Dad's)",w:"Digital — QR in the SmartEX email or ICOCA linked in the app.",u:"https://smart-ex.jp/en/index.php",jp:"10月1日（木）　のぞみ122号　名古屋 11:29発 → 品川 12:58着　指定席　大人2名　E席（富士山側）　※スマートEX予約済み 2002",note:"Flat check-in is 15:00 — no need for an earlier one."}
];
P.TRAINS=TRAINS;
...
P.renderBudget=function(){
 ...
 h+='<div class="bigfig two">'+
   '<details class="bf exp"><summary><div class="bfk">BOOKINGS PAID</div><div class="bfv">'+money(paidTot)+'</div>'+
     ...
     '<p class="bfnote">HOSHINOYA Kyoto (23–25 Sep) is not in this list because it was a gift — nothing to pay, nothing to budget for.</p>'+
     '</div></details>'+
 ...
 h+='<div style="overflow-x:auto"><table class="simple"><tr><th>LEG</th><th>STATUS</th><th>PAID (TWO)</th><th>NOTE</th></tr>'+
  '<tr><td>Kansai Airport → Kyoto — 19 Sep</td><td>BOOKED ✓</td><td>£24.31</td><td>HARUKA 30, 14:14 → 15:34. Ref 41082 + PIN, collect at the KIX machine</td></tr>'+
  '<tr><td>Kameoka → Amanohashidate — 25 Sep</td><td>BOOKED ✓</td><td>£51.38</td><td>HASHIDATE 5, 10:43 → 12:36. Ref 48623, car 1 8C/8D — collect at Kyoto 19 Sep</td></tr>'+
  '<tr><td>Amanohashidate → Kyoto — 27 Sep</td><td>BOOKED ✓</td><td>£55.25</td><td>HASHIDATE 2, 09:50 → 12:07. Ref 42734, car 1 8C/8D — collect at Kyoto 19 Sep</td></tr>'+
  '<tr><td>Kyoto → Nara — 27 Sep</td><td>BOOKED ✓</td><td>£8.07</td><td>AONIYOSHI 12:55, Twin seats, Kintetsu A03269 (express charge; fare by ICOCA)</td></tr>'+
  '<tr><td>Kyoto → Nagoya — 28 Sep</td><td>BOOKED ✓</td><td>£60.88</td><td>NOZOMI 22, 13:21 → 13:55. SmartEX 2001, car 4 4D/4E</td></tr>'+
  '<tr><td>Nagoya → Nagiso — 28 Sep</td><td>BOOKED ✓</td><td>£35.58</td><td>SHINANO 17, 15:00 → 16:00. Ref 42626, car 2 9A/9B — collect at Kyoto 19 Sep</td></tr>'+
  '<tr><td>Nagiso → Nagoya — 1 Oct</td><td>BOOKED ✓</td><td>£35.58</td><td>SHINANO 2, 08:09 → 09:18. Ref 42281, car 3 8C/8D — collect at Kyoto 19 Sep</td></tr>'+
  '<tr><td>Nagoya → Shinagawa — 1 Oct</td><td>BOOKED ✓</td><td>£120.44</td><td>NOZOMI 122, 11:29 → 12:58. SmartEX 2002, car 4 10D/10E — E is Dad\'s Fuji window</td></tr>'+
